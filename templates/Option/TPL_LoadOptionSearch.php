    ...
    <table class="w3-table-all w3-small">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {foreach $option_list[$list[outer].code] key=k item=v}
                    <a href="javascript:void(0);" class="w3-text-{if $v.status eq '1'}theme{else}red{/if}" onclick="ChangeList('{$list[outer].code}','{$v.id}')">{$k} = {$v.name}</a><br>
                    {/foreach}
                </td>
                ...
                <td>
                    <div class="w3-dropdown-hover w3-right">
                        ...
                        <div class="w3-dropdown-content w3-bar-block w3-border w3-border-theme-d2" style="right: 0;">
                          <button class="w3-bar-item w3-button w3-hover-theme-d2" onclick="AddList('{$list[outer].code}');">Add List</button>
