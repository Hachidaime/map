    ...
    <table class="w3-table-all w3-small">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{$list[outer].status_kepemilikan}</td>
                <td>{$list[outer].no_jalan}</td>
                <td>{$list[outer].nama_jalan}</td>
                <td>
                    <div class="w3-dropdown-hover w3-right">
                        ...
                        <div class="w3-dropdown-content w3-bar-block w3-border w3-border-theme-d2" style="right: 0;">
                          <button class="w3-bar-item w3-button w3-hover-theme-d2" onclick="LoadCoordinate({$list[outer].id});">Koordinat</button>
