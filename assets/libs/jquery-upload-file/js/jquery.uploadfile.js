...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadButtonClass: "w3-button w3-hover-white w3-hover-text-theme-d2 w3-theme-d2 w3-text-white w3-border-theme-d2 w3-border w3-ripple w3-round-xxlarge w3-padding-small upload-btn",
            dragDropStr: "<span><b>Drag &amp; Drop Files</b></span>",
            uploadStr:"&nbsp;&nbsp;&nbsp;<i class='fas fa-file-upload'></i> Upload&nbsp;&nbsp;&nbsp;",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deleteStr: "<i class='fas fa-trash'></i> Delete",
            doneStr: "Done",
	...
	this.enqueueFile = function(file){
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.statusbar = $("<div class='w3-border w3-border-theme w3-margin-top w3-padding w3-round'></div>").width(s.statusBarWidth);
            this.preview = $("<img class='ajax-file-upload-preview' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
            this.filename = $("<div class='ajax-file-upload-filename'></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='ajax-file-upload-bar w3-theme-d1'></div>").appendTo(this.progressDiv);
            ...
            this.del.addClass("w3-button w3-hover-white w3-hover-text-highway-red w3-highway-red w3-border-highway-red w3-border w3-ripple w3-round-xxlarge w3-padding-small w3-small w3-margin-bottom");
